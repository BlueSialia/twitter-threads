...
(function () {
  ...
  var Codebird = function () {
    ...
    _createClass(Codebird, [{
       ...
       * @param array  params  The parameters to send along
       *
       * @return null|string The built multipart request firstList
       */
      ...
      /**
       * Detects if API call should use JSON firstList
       *
       * @param string method The API method to call
       *
       * @return bool Whether the method is defined as accepting JSON firstList
       */
